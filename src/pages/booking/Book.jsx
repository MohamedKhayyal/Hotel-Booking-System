...
export default function Book() {
  ...
  if (bookings.length === 0) {
    return <div className="p-8 text-lg">No bookings yet.</div>;
  }

  return (
    <div className="pt-28 md:pt-35 px-2 sm:px-4 md:px-16 lg:px-24 xl:px-32">
      <h2 className="text-3xl font-playfair font-bold mb-2">My Bookings</h2>
        ...
        {bookings.map((b, idx) => (
          ...
          >
            ...
            <div className="w-full sm:w-1/12 flex justify-center mt-2 sm:mt-0">
              ...
              >
                <img src={assets.closeIcon} alt="Delete" className="w-5 h-5" />
              </button>
            </div>
          </div>
        ))}
